...
@bot.on_message(filters.command(["meresona"]))
async def account_login(bot: Client, m: Message):
    editable = await m.reply_text("**ℍɪɪ ┈━═.•°🅲🆁🅰🆉🆈_🅼🅸🅽🅳°•.═━┈😎 \n\n  𝔾ɪᴠᴇ /crazy ℂᴏᴍᴍᴀɴᴅ ᴛᴏ 𝔻ᴏᴡɴʟᴀᴏᴅ 𝔽ʀᴏᴍ ᴀ 𝕋ᴇ𝕩ᴛ ғɪʟᴇ.⚡️\n**")


@bot.on_message(filters.command("aberukja"))
async def restart_handler(_, m):
    await m.reply_text("**ℝ𝕦𝕜 𝔾𝕒𝕪𝕒 𝕄𝕒𝕒𝕝𝕚𝕜😁😎**", True)
